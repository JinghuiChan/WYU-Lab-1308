...
* ### <a href="#1">VR设备配件列表</a>
* ### <a href="#2">VR设备安装教程</a>
   * #### <a href="#2.1">规划选择游戏区</a>
   * #### <a href="#2.2">安装定位器</a>
   * #### <a href="#2.3">首次设置Vive</a>
* ### <a href="#3">体验测试</a>
   * #### <a href="#3.1">启动 Vive 系统</a>
   * #### <a href="#3.2">将头戴式设备连接到电脑</a>
   * #### <a href="#3.3">佩戴头戴设备</a>
   * #### <a href="#3.4">将USB 设备连接到头戴式设备</a>
* #### <a href="#4">关闭 Vive 系统</a>
